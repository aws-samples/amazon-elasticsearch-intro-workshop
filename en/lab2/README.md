...
1. Click ![kibana_visualize](../images/kibana_visualize.png) icon on the left menu of the screen to open the Visualize page. Next, click **[+]** button on the top right of the screen to go to the graph creation screen. From the pop-up menu choose **[Metric]**. After moving onto the data source selection screen, the graph creation screen will open by choosing **[workshop-log]**.
